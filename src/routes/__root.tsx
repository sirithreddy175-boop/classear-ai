  ...
  head: () => ({
    meta: [
      ...
      { title: "Classear.AI — Your class, heard and understood" },
      {
        name: "description",
        content:
          "Classear.AI listens to your class and turns it into a summary, key points, concepts, exam questions and revision notes.",
      },
      { name: "author", content: "Classear.AI" },
      { property: "og:title", content: "Classear.AI — Your class, heard and understood" },
      {
        property: "og:description",
        content: "An AI study companion that listens to your class and explains it back.",
      },
